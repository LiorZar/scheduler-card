...
`;var Ua="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",Ha="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";const Ba={alarm_control_panel:"domains.alarm_control_panel",automation:"ui.dialogs.quick-bar.commands.navigation.automation",binary_sensor:"domains.binary_sensor",calendar:"panel.calendar",climate:"domains.climate",cover:"domains.cover",fan:"domains.fan",group:"domains.group",humidifier:"domains.humidifier",input_boolean:"domains.input_boolean",input_number:"domains.input_number",input_select:"domains.input_select",lawn_mower:"domains.lawn_mower",light:"domains.light",lock:"domains.lock",media_player:"domains.media_player",notify:"domains.notify",person:"ui.dialogs.quick-bar.commands.navigation.person",scene:"ui.dialogs.quick-bar.commands.navigation.scene",script:"ui.dialogs.quick-bar.commands.navigation.script",sensor:"ui.panel.config.devices.entities.sensor",sun:"ui.panel.config.automation.editor.conditions.type.sun.label",switch:"domains.switch",vacuum:"domains.vacuum",water_heater:"domains.water_heater"},Fa=(e,t)=>{if(e in Ba){const i=Ba[e],s=i.startsWith("domains")?Ws(i,rt(t)):t.localize(i);if(s)return s}return e};function Ya(e,t,i){let s=[];t.groups&&t.groups.forEach(t=>{e.find(e=>fa(e,t))&&(s=[...s,{name:t.name,icon:t.icon||"folder-outline",entities:e.filter(e=>fa(e,t))}])});const a=e.filter(e=>!s.some(t=>t.entities.includes(e)));return a.map(Le).filter((e,t,i)=>i.indexOf(e)===t).forEach(e=>{s=[...s,{name:Fa(e,i),icon:(void 0===t.standard_configuration||t.standard_configuration)&&e in ct?ct[e]:"folder-outline",entities:a.filter(t=>fa(t,{include:[e],exclude:[]}))}]}),s}const Za={options:["on","off"]},Wa={alarm_control_panel:{template:e=>{let t=["disarmed","triggered"];const i=Ct(e,"supported_features")||0;return 2&i&&(t=[...t,"armed_away"]),1&i&&(t=[...t,"armed_home"]),4&i&&(t=[...t,"armed_night"]),16&i&&(t=[...t,"armed_custom_bypass"]),32&i&&(t=[...t,"armed_vacation"]),{options:t}}},binary_sensor:Za,climate:{options:"hvac_modes"},calendar:Za,cover:{options:["open","closed"]},device_tracker:{options:["home","not_home"]},fan:Za,humidifier:Za,input_boolean:Za,input_number:{min:"min",max:"max",unit:"unit_of_measurement",step:"step"},input_select:{options:"options"},light:Za,lock:{options:["locked","unlocked"]},number:{min:"min",max:"max",step:"step"},person:{template:(e,t)=>{const i=Object.keys(t.states).filter(e=>"zone"==Le(e)).map(Pe);return{options:[...new Set(["home","not_home",...i])]}}},proximity:{unit:"unit_of_measurement"},select:{options:"options"},sensor:{template:e=>e&&!isNaN(Number(e.state))?"%"==Dt(e,"unit_of_measurement")?{min:0,max:100,unit:"%",step:1}:{unit:"unit_of_measurement"}:{}},sun:{options:["below_horizon","above_horizon"]},switch:Za,timer:{options:["active","paused","idle"]},water_heater:{options:"operation_list"}},Ga=(e,t)=>He(Object.assign(Object.assign({},e),{state:t})),Ka=(e,t)=>{const i="closed"==t;switch(e.attributes.device_class){case"garage":return i?"mdi:garage":"mdi:garage-open";case"door":return i?"mdi:door-closed":"mdi:door-open";case"blind":return i?"mdi:blinds":"mdi:blinds-open";case"window":return i?"mdi:window-closed":"mdi:window-open";default:return i?"mdi:window-shutter":"mdi:window-shutter-open"}},Ja={alarm_control_panel:{disarmed:"mdi:lock-open-variant-outline",armed_away:"mdi:exit-run",armed_home:"mdi:home-outline",armed_night:"mdi:power-sleep",triggered:"mdi:alarm-light-outline"},binary_sensor:{on:Ga,off:Ga},calendar:{on:"mdi:flash",off:"mdi:flash-off"},climate:{off:"mdi:power-off",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:thermometer",auto:"mdi:autorenew",dry:"mdi:water-percent",fan_only:"mdi:fan"},cover:{closed:Ka,open:Ka},device_tracker:{home:"mdi:home-outline",not_home:"mdi:exit-run"},fan:{on:"mdi:power",off:"mdi:power-off"},humidifier:{on:"mdi:power",off:"mdi:power-off"},input_boolean:{on:"mdi:flash",off:"mdi:flash-off"},light:{on:"mdi:lightbulb",off:"mdi:lightbulb-off"},lock:{unlocked:"mdi:lock-open-variant-outline",locked:"mdi:lock-outline"},person:(e,t,i)=>{const s={home:"mdi:home-outline",not_home:"mdi:exit-run"};return Object.keys(i.states).filter(e=>"zone"==Le(e)).forEach(e=>{const t=Pe(e),a=i.states[e].attributes.icon;a&&(s[t]=a)}),t in s?s[t]:"mdi:flash"},sensor:{unit:"attributes.unit_of_measurement"},sun:{below_horizon:"mdi:weather-sunny-off",above_horizon:"mdi:weather-sunny"},switch:{on:"mdi:flash",off:"mdi:flash-off"},timer:{active:"mdi:play",paused:"mdi:pause",idle:"mdi:sleep"}},Xa=(e,t,i,s)=>{const a=Le(e.entity_id);if(t||(t=e.state),a in Ja){if(t in Ja[a]){const s=Ja[a][t];return"string"==typeof s?s:s(e,t,i)}if("function"==typeof Ja[a])return Ja[a](e,t,i)}return s||"folder-outline"};function Qa(e,t){const i=Le(e),s=t.states[e];if(!s)return null;if("group"==i){const i=t.states[e],s=Mt(i,"entity_id");if(!s.length)return null;const o=s.map(e=>Qa(e,t));return o.every(et)?(a=o).length&&a.every(e=>e.type==a[0].type)?a[0].type==$t.List?Yt(...a):a[0].type==$t.Level?Pt(...a):null:null:null}var a;if(!Object.keys(Wa).includes(i))return null;let o=Tt(Wa[i],s,t);if("options"in o&&et(o.options)){let e=[...o.options];return e=e.map(e=>Object.assign(e,{icon:e.icon?e.icon:Xa(s,e.value,t,"flash"),name:e.name?e.name:eo(s,e.value,t)})),o=Object.assign(Object.assign({},o),{options:e}),e.length?Yt(o):null}return"min"in o&&et(o.min)&&"max"in o&&et(o.max)?Pt(o):Wt(o)}const eo=(e,t,i)=>{const s=Le(e.entity_id);return e.attributes.device_class&&i.localize(`component.${s}.entity_component._.${e.attributes.device_class}.state.${t}`)||i.localize(`component.${s}.entity_component._.state.${t}`)||t};function to(e,t,i){let s=i.standard_configuration?Qa(e,t):null;const a=Object.entries(i.customize).filter(([t])=>mt(t,e)).sort((e,t)=>t[0].length-e[0].length).map(([,e])=>e.states).filter(et);return a.length&&a.forEach(e=>{s=Array.isArray(e)?Yt({options:e.map(e=>Object({value:e}))}):Pt(e)}),s}function io(e,t,i={filterActions:!0,filterStates:!1}){let s=Object.keys(e.states).filter(e=>fa(e,t));return"notify"in e.services&&(s=[...s,...Object.keys(e.services.notify).map(e=>"notify."+e).filter(e=>fa(e,t))]),i.filterActions&&i.filterStates?s=s.filter(i=>va(i,e,t).length||to(i,e,t)):i.filterActions?s=s.filter(i=>va(i,e,t).length):i.filterStates&&(s=s.filter(i=>to(i,e,t))),s}const so=(e,t)=>{let i={entity_id:e,service:t.service,service_data:Object.assign({},t.service_data)};return Object.entries(t.variables||{}).forEach(([e,t])=>{Object.keys(i.service_data||{}).includes(e)||(t.type==$t.Level?(t=t,i=Object.assign(Object.assign({},i),{service_data:t.optional?Je(i.service_data||{},e):Object.assign(Object.assign({},i.service_data),{[e]:parseFloat((t.min*t.scale_factor).toPrecision(12))||0})})):t.type==$t.List?(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:t.options.length?t.options[0].value:void 0})})):t.type==$t.Text&&(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:""})})))}),i},ao=(e,t,i,s)=>{if(!e)return null;const a=ga(e,s),o=i.find(e=>na(e,a,!0));if(!o)return null;let n=t.map(e=>so(e,o));return n=Object.keys(o.variables||{}).filter(t=>Object.keys(e.service_data||{}).includes(t)).reduce((t,i)=>{if(!t)return t;switch(o.variables[i].type){case $t.Level:const s=o.variables[i];let a=Number(e.service_data[i]);return a/=s.scale_factor,a=Math.round(a/s.step)*s.step,a=parseFloat(a.toPrecision(12)),a>s.max?a=s.max:a<s.min&&(a=s.min),a*=s.scale_factor,a=parseFloat(a.toFixed(2)),t.map(e=>Object.assign(e,{service_data:Object.assign(Object.assign({},e.service_data),{[i]:a})}));case $t.List:return o.variables[i].options.some(t=>t.value==e.service_data[i])?t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})})):null;case $t.Text:return t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})}));default:return t}},n),n};function oo(e,t){return e.id||e.value||t}let no=class extends oe{constructor(){super(...arguments),this.items=[],this.value=null}render(){return this.items.length?this.items.map((e,t)=>this.renderButton(e,t)):q`
        <div class="text-field">
          <slot></slot>
        </div>
      `}renderButton(e,t){const i=Array.isArray(this.value)?this.value:[this.value],s=oo(e,t);return q`
      <mwc-button
    ...
    `}};t([de({attribute:!1})],ro.prototype,"hass",void 0),t([ce()],ro.prototype,"_params",void 0),ro=t([re("generic-dialog")],ro);var lo=Object.freeze({__proto__:null,get GenericDialog(){return ro}});const co=[{start:"00:00:00",stop:"08:00:00",actions:[]},{start:"08:00:00",stop:"16:00:00",actions:[]},{start:"16:00:00",stop:"00:00:00",actions:[]}];let uo=class extends oe{constructor(){super(...arguments),this.entities=[],this.multipleEntity=!1,this.scheduleEntities=[],this.timeSchemeSelected=!1,this.editItem=!1}provideHass(e){e.hass=this.hass}async firstUpdated(){if(this.scheduleEntities=(await ft(this.hass)).map(e=>e.entity_id),this.entities&&this.entities.length){const e=this.getGroups().find(e=>e.entities.find(e=>e==this.entities[0]));if(!e)return;this.selectedGroup=e,this.multipleEntity=this.entities.length>1}if(this.schedule)if(this.schedule.timeslots.every(e=>e.stop))this.timeSchemeSelected=!0;else{const e=Qe(Xe(this.schedule.timeslots.map(e=>e.actions))),t=this.getActionsForEntity().filter(t=>e.some(e=>na(e,t,!0)));1==t.length&&(this.selectedAction=t[0])}}getGroups(){if(!this.hass||!this.config)return[];const e=Ya(io(this.hass,this.config).filter(e=>"switch"!==Le(e)||!this.scheduleEntities.includes(e)),this.config,this.hass);return e.push({name:"conx",icon:"mdi:script",entities:["conx.sk"]}),e.sort(it),e}getEntitiesForGroup(){if(!this.selectedGroup||!this.hass||!this.config)return[];const e=this.selectedGroup.entities.map(e=>ht(e,this.hass,this.config));return e.sort(it),e}getActionsForEntity(e){if(e||(e=this.entities),!this.hass||!this.config||!e.length)return[];const t=va(e,this.hass,this.config).map(e=>Object.assign(e,{name:_a(e)}));return t.sort(it),t}render(){var e;if(!this.hass||!this.config)return q``;const t=this.getGroups();1!=t.length||tt(this.selectedGroup,t[0])||this.selectGroup(t[0]);const i=this.getEntitiesForGroup();1==i.length&&this.entities[0]!==i[0].id&&this.selectEntity(i[0].id);const s=this.getActionsForEntity();return q`
      <div class="content">
        ...
        >
          ${Ws("ui.panel.entity_picker.no_groups_defined",rt(this.hass))}
        </button-group>
        ...
        <div class="header">
          ...
          ${i.length>1?q`
                <div class="switch">
                  ...
                  ${Ws("ui.panel.entity_picker.multiple",rt(this.hass))}
                </div>
              `:""}
        </div>
        <button-group
          ...
          id="selectedEntity"
        >
          ${this.selectedGroup?Ws("ui.panel.entity_picker.no_entities_for_group",rt(this.hass)):Ws("ui.panel.entity_picker.no_group_selected",rt(this.hass))}
        </button-group>
        ...
        <button-group
          ...
          id="selectedAction"
        >
          ${this.entities.length?Ws("ui.panel.entity_picker.no_actions_for_entity",rt(this.hass)):Ws("ui.panel.entity_picker.no_entity_selected",rt(this.hass))}
        </button-group>
    ...
    `}makeSchemeButton(e){return e.length&&this.hass?q`
      ...
      <div class="option-list">
        <mwc-button
          ...
          ${Ws("ui.panel.entity_picker.make_scheme",rt(this.hass))}
        </mwc-button>
      </div>
    </div>
    `:q``}selectGroup(e){this.selectedGroup=e,this.entities=[],this.selectedAction=void 0}async selectEntity(e){const t=lt("object"==typeof e?e.target.value:e);let i=this.selectedAction;if(i){let e=this.getActionsForEntity(t);this.entities.every(e=>"script"==Le(e))&&this.entities.includes(i.service)?(i=Object.assign(Object.assign({},i),{service:"script.script"}),e=e.map(e=>t.includes(e.service)?Object.assign(Object.assign({},e),{service:"script.script"}):e),i=e.find(e=>na(e,i)),i=Object.assign(Object.assign({},i),{service:t[0]})):i=e.find(e=>na(e,i))}else i=void 0;if(this.schedule&&t.length&&(this.timeSchemeSelected||this.selectedAction)){const s=await this.migrateSchedule(t,this.timeSchemeSelected?null:i);if(!s)return this.selectedAction=null,"object"==typeof e&&e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedEntity").value=this.entities);this.entities=t,this.selectedAction=i,this.dispatchEvent(new CustomEvent("change",{detail:s}))}else this.entities=t,this.selectedAction=i}async selectAction(e){const t=e.detail;if(this.schedule){const i=await this.migrateSchedule(this.entities,t);if(!i)return this.selectedAction=null,e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedAction").value=null);this.dispatchEvent(new CustomEvent("change",{detail:i}))}this.selectedAction=t,this.timeSchemeSelected=!1}async selectTimeScheme(e){if(this.schedule){const t=await this.migrateSchedule(this.entities,null);if(!t)return void e.stopPropagation();this.dispatchEvent(new CustomEvent("change",{detail:t}))}this.selectedAction=null,this.timeSchemeSelected=!0}nextClick(){if(!this.hass||!this.config||!this.selectedAction&&!this.timeSchemeSelected)return;const e=1==lt(this.config.tags).length?lt(this.config.tags).slice(0,1):[];if(this.timeSchemeSelected)this.actions=va(this.entities,this.hass,this.config),this.schedule={months:["monthly"],weekdays:["daily"],timeslots:co,repeat_type:xt.Repeat,tags:e};else{let t=Ye(Sa(new Date,rt(this.hass),Te.twenty_four),this.hass);t=We(t,this.config.time_step,{wrapAround:!0}),this.actions=[this.selectedAction];const i={start:Ze(t),actions:this.entities.map(e=>so(e,this.actions[0]))};this.schedule={months:["monthly"],weekdays:["daily"],timeslots:[i],repeat_type:xt.Repeat,tags:e}}this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule,entities:this.entities.map(e=>ht(e,this.hass,this.config)),actions:this.actions,tab:Be.Time}}))}migrateSchedule(e,t){let i=!0,s=function e(t){return null==t?t:t instanceof Array?t.reduce((t,i,s)=>(t[s]=e(i),t),[]):t instanceof Object?Object.keys(t).reduce((i,s)=>(i[s]=e(t[s]),i),{}):t}(this.schedule);const a=null!==t?[t]:va(e,this.hass,this.config);if(this.timeSchemeSelected)if(null!==t){let t=Ye(Sa(new Date,rt(this.hass),Te.twenty_four),this.hass);t=We(t,this.config.time_step,{wrapAround:!0});const o={start:Ze(t),actions:e.map(e=>so(e,a[0]))};s=Object.assign(Object.assign({},s),{timeslots:[o]}),i=!1}else{const t=s.timeslots.map(e=>e.actions[0]),o=t.map(t=>ao(t,e,a,this.hass));i=t.every((e,t)=>null!==o[t]&&na(e,o[t][0])),s=Object.assign(Object.assign({},s),{timeslots:s.timeslots.map((e,t)=>Object.assign(e,{actions:o[t]||[]}))})}else if(null!==t){const t=ao(s.timeslots[0].actions[0],e,a,this.hass)||e.map(e=>so(e,a[0]));s=Object.assign(Object.assign({},s),{timeslots:[Object.assign(Object.assign({},s.timeslots[0]),{actions:t})]})}else s=Object.assign(Object.assign({},s),{timeslots:co}),i=!1;const o={schedule:s,actions:a,entities:e.map(e=>ht(e,this.hass,this.config))};return new Promise(e=>{if(i)e(o);else{const t={title:Ws("ui.dialog.confirm_migrate.title",rt(this.hass)),description:Ws("ui.dialog.confirm_migrate.description",rt(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{e(!1)},confirm:()=>{e(o)}};gt(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return lo})),dialogParams:t},this.cardEmbeddedInPopup)}})}};uo.styles=r`
    ${Va}
  `,t([de()],uo.prototype,"hass",void 0),t([de()],uo.prototype,"config",void 0),t([de()],uo.prototype,"selectedGroup",void 0),t([de()],uo.prototype,"selectedAction",void 0),t([de()],uo.prototype,"entities",void 0),t([de()],uo.prototype,"schedule",void 0),t([de()],uo.prototype,"multipleEntity",void 0),t([de()],uo.prototype,"scheduleEntities",void 0),t([de()],uo.prototype,"timeSchemeSelected",void 0),t([de({type:Boolean})],uo.prototype,"editItem",void 0),uo=t([re("scheduler-editor-entity")],uo);const mo=(e,t,i={})=>{const s=Ge(e);if(!s)return e;const a=t.states["sun.sun"],o="sunrise"==s.event?Ye(a.attributes.next_rising,t):Ye(a.attributes.next_setting,t);let n="+"==s.sign?o+Ye(s.offset,t):o-Ye(s.offset,t);return i.stepSize&&(n=We(n,i.stepSize)),Ze(n)},ho=(e,t,i,s={})=>{Ge(e)&&(e=mo(e,i));const a=Ye(e,i),o=i.states["sun.sun"],n=Ye(o.attributes.next_rising,i),r=Ye(o.attributes.next_setting,i);t||(t=Math.abs(a-n)<Math.abs(a-r)?Ot.Sunrise:Ot.Sunset);let l=a-(t==Ot.Sunrise?Ye(o.attributes.next_rising,i):Ye(o.attributes.next_setting,i));return s.stepSize&&(l=We(l,s.stepSize,{maxHours:6})),`${t}${l>0?"+":"-"}${Ze(Math.abs(l))}`};let po=class extends oe{constructor(){super(...arguments),this.stepSize=10,this.relativeMode=!1,this.event=Ot.Sunrise,this.maxOffset=6}get time(){return this._time>=0?this._time:Math.abs(this._time)}set time(e){const t=We(e,this.stepSize,{wrapAround:!this.relativeMode,maxHours:this.relativeMode?this.maxOffset:void 0}),i=t!=this._time&&et(this._time);this._time=t,i&&this.updateValue()}firstUpdated(){const e=Ge(this.value);e?(this.relativeMode=!0,this.event=e.event==Ot.Sunrise?Ot.Sunrise:Ot.Sunset,this.time="+"==e.sign?Ye(e.offset,this.hass):-Ye(e.offset,this.hass)):this.time=Ye(this.value,this.hass)}updateValue(){if(this.relativeMode){const e=this._time>=0?"+":"-",t=Ze(this.time);this.value=`${this.event}${e}${t}`}else this.value=Ze(this.time);const e=new CustomEvent("change");this.dispatchEvent(e)}getTimeParts(){const e=(this.relativeMode?Ze(this.time):Sa(Ea(Ze(this.time)),rt(this.hass))).split(/:|\ /);return e[0]=String(Number(e[0])),e}render(){const e=this.getTimeParts();return q`
    ...
    `:q``}getBeforeAfter(){return this.hass?this._time<0?this.hass.localize("ui.panel.config.automation.editor.conditions.type.sun.before").trim():this.hass.localize("ui.panel.config.automation.editor.conditions.type.sun.after").trim():""}toggleAmPm(){this.time=this._time+43200}toggleBeforeAfter(){this.time=-this._time,this.updateValue()}toggleSunriseSunset(){this.event=this.event==Ot.Sunrise?Ot.Sunset:Ot.Sunrise,this.updateValue()}toggleMode(){if(!this.hass)return;this.relativeMode=!this.relativeMode;const e=this.hass.states["sun.sun"],t=Ye(e.attributes.next_rising,this.hass),i=Ye(e.attributes.next_setting,this.hass);if(this.relativeMode){this.event=Math.abs(this._time-t)<Math.abs(this._time-i)?Ot.Sunrise:Ot.Sunset;let e=this.event==Ot.Sunrise?this._time-t:this._time-i;e>3600*this.maxOffset?e=3600*this.maxOffset:e<3600*-this.maxOffset&&(e=3600*-this.maxOffset),this.time=e}else this.time=this.event==Ot.Sunrise?this._time+t:this._time+i}_hoursChanged(e,t=!1){const i=e.target,s=i.value;let a=Number(s);const o=this.relativeMode?0:t?1:0,n=this.relativeMode?this.maxOffset:t?12:23;let r=!0;s.length>2&&(r=!1,a=Number(s.substring(0,2))),a<0&&(r=!1,a=-a),a<o&&(r=!1,a=o),a>n&&(r=!1,a=n),r||(i.value=String(a),i.blur())}_minutesChanged(e){const t=e.target,i=t.value;let s=Number(i),a=!0;i.length>2&&(a=!1,s=Number(i.substring(0,2))),s<0&&(a=!1,s=-s),s>59&&(a=!1,s=59),s%this.stepSize!=0&&(s=Math.round(s/this.stepSize)*this.stepSize),a||(t.value=String(s).padStart(2,"0"),t.blur())}_onFocus(e){e.target.value=""}_handleHoursInput(e,t){const i=e.target;let s=Number(i.value);if(!i.value.length)return void(i.value=t[0]);t.length>2&&12==s&&(s=0),t.length>2&&"PM"==t[2]&&(s+=12);const a=Number(t[1]);this.time=this._time>=0?3600*s+60*a:-(3600*s+60*a),i.value=this.getTimeParts()[0]}_handleMinutesInput(e,t){const i=e.target;let s=Number(i.value);if(!i.value.length)return void(i.value=t[1]);s%this.stepSize!=0&&(s=Math.round(s/this.stepSize)*this.stepSize);let a=Number(t[0]);t.length>2&&12==a&&(a=0),t.length>2&&"PM"==t[2]&&(a+=12),this.time=this._time>=0?3600*a+60*s:-(3600*a+60*s),i.value=this.getTimeParts()[1]}};po.styles=r`
    div.time-picker {
      display: grid;
  ...
  `,t([de()],po.prototype,"hass",void 0),t([de({type:Number})],po.prototype,"stepSize",void 0),t([de()],po.prototype,"relativeMode",void 0),t([de()],po.prototype,"event",void 0),t([de()],po.prototype,"_time",void 0),po=t([re("time-picker")],po);let _o=class extends oe{constructor(){super(),this.slots=[],this.actions=[],this.stepSize=10,this.isDragging=!1,this.currentTime=0,this.rangeMin=0,this.rangeMax=86400,this.activeSlot=null,this.activeMarker=null,this.previousSlot=null,this.timer=0,this.timeout=0,this.zoomFactor=1,this.large=!1,this.handleResize=this.handleResize.bind(this)}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){window.addEventListener("resize",this.handleResize)}disconnectedCallback(){window.removeEventListener("resize",this.handleResize),clearInterval(this.timer),clearTimeout(this.timeout),super.disconnectedCallback&&super.disconnectedCallback()}render(){if(!this.hass)return q``;const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=86400/(this.rangeMax-this.rangeMin)*e,i=-this.rangeMin/(this.rangeMax-this.rangeMin)*e;return q`
      <div class="outer">
        <div
    ...
    `}};t([de()],_o.prototype,"hass",void 0),t([de({type:Array})],_o.prototype,"slots",void 0),t([de({type:Array})],_o.prototype,"actions",void 0),t([de({type:Number})],_o.prototype,"stepSize",void 0),t([de()],_o.prototype,"rangeMin",void 0),t([de()],_o.prototype,"rangeMax",void 0),t([de()],_o.prototype,"activeSlot",void 0),t([de()],_o.prototype,"activeMarker",void 0),t([de({type:Boolean})],_o.prototype,"large",void 0),t([function(e){return ue({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */({passive:!0})],_o.prototype,"_handleTouchStart",null),_o=t([re("timeslot-editor")],_o);const vo=async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()};let go=class extends oe{constructor(){super(...arguments),this.min=0,this.max=255,this.step=1,this.scaleFactor=1,this.unit="",this.optional=!1,this.disabled=!1,this._displayedValue=0}set value(e){e=isNaN(e)?this.min:this._roundedValue(e/this.scaleFactor),this._displayedValue=e}firstUpdated(){(async()=>{await vo()})(),this.disabled&&!this.optional&&(this.disabled=!1,this.requestUpdate())}render(){return q`
    ...
    `:q``}toggleChecked(e){const t=e.target.checked;this.disabled=!t;const i=this.disabled?null:this._scaledValue(this._displayedValue);Ie(this,"value-changed",{value:i})}_updateValue(e){let t=Number(e.target.value);this._displayedValue=t,t=this._scaledValue(this._displayedValue),Ie(this,"value-changed",{value:t})}_roundedValue(e){return e=Math.round(e/this.step)*this.step,(e=parseFloat(e.toPrecision(12)))>this.max?e=this.max:e<this.min&&(e=this.min),e}_scaledValue(e){return e=this._roundedValue(e),e*=this.scaleFactor,e=parseFloat(e.toFixed(2))}};go.styles=r`
    ${Va} :host {
      width: 100%;
    }
    ha-slider {
  ...
  `,t([de({type:Number})],go.prototype,"min",void 0),t([de({type:Number})],go.prototype,"max",void 0),t([de({type:Number})],go.prototype,"step",void 0),t([de({type:Number})],go.prototype,"value",null),t([de({type:Number})],go.prototype,"scaleFactor",void 0),t([de({type:String})],go.prototype,"unit",void 0),t([de({type:Boolean})],go.prototype,"optional",void 0),t([de({type:Boolean})],go.prototype,"disabled",void 0),t([de({type:Number})],go.prototype,"_displayedValue",void 0),go=t([re("variable-slider")],go);let fo=class extends oe{firstUpdated(){var e;null!==this.value&&void 0!==this.value||(null===(e=this.variable)||void 0===e?void 0:e.type)!=$t.Level||this.variable.optional||this.levelVariableUpdated(this.variable.min)}render(){return this.variable?this.variable.type==$t.Level?this.renderLevelVariable():this.variable.type==$t.List?this.renderListVariable():this.variable.type==$t.Text?this.renderTextVariable():q``:q``}levelVariableUpdated(e){const t="number"==typeof e?e:Number(e.detail.value);this.value=t,Ie(this,"value-changed",{value:t})}renderLevelVariable(){const e=this.variable,t=Number(this.value);return q`
      <variable-slider
        min=${e.min}
        max=${e.max}
        step=${e.step}
  ...
  `,t([de()],fo.prototype,"variable",void 0),t([de()],fo.prototype,"value",void 0),fo=t([re("scheduler-variable-picker")],fo);let yo=class extends oe{constructor(){super(...arguments),this.activeEntry=null,this.activeMarker=null,this.timeslots=!1,this.editItem=!1,this.large=!1}firstUpdated(){if(!this.actions||!this.hass)return;this.timeslots||(this.activeEntry=0);const e=this.actions.map(e=>{const t=Object.assign(Object.assign({},e),{service_data:Je(e.service_data||{},...Object.keys(e.variables||{}))});return Object.assign(e,{name:_a(t)})});e.sort(it),this.actions=e}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return this.hass&&this.config&&this.entities&&this.actions?q`
      <div class="content">
        <div class="header">
          ${this.hass.localize("ui.panel.config.automation.editor.actions.type.device_id.action")}
        </div>
        ...
        ${this.timeslots?q`
              ${this.renderDays()}
              <div class="header">${Ws("ui.panel.time_picker.time_scheme",rt(this.hass))}</div>
        ...
        <div class="summary-action">
          ${this.timeslots?q`
                <div>
                  ...
                  ${st(Ws("ui.panel.entity_picker.make_scheme",rt(this.hass)))}
                </div>
              `:q`
                <div>
    ...
    `:q``}renderDays(){if(!this.hass)return q``;let e=Array.from(Array(7).keys());const t=function(e){const t=e.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i),i=t[1],s=t[4],a="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),o="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),n="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g);return s?o.includes(s)?"sun":a.includes(s)?"sat":"mon":n.includes(i)?"sun":["ar","arq","arz","fa"].includes(i)?"sat":"mon"}(this.hass.language),i=e.length-ba.findIndex(e=>e.substr(0,3)==t);e=[...e.slice(-i),...e.slice(0,-i)];const s=e.map(e=>Object({value:ba[e].substr(0,3),name:xa(e,rt(this.hass),!0)})),a=[{value:Et.Daily,name:Ws("ui.components.date.day_types_short.daily",rt(this.hass))},{value:Et.Workday,name:Ws("ui.components.date.day_types_short.workdays",rt(this.hass))},{value:Et.Weekend,name:Ws("ui.components.date.day_types_short.weekend",rt(this.hass))},{value:Et.Custom,name:Ws("ui.components.date.day_types_short.choose",rt(this.hass))}];const o=Array.from(Array(12).keys()).map(e=>Object({value:ya[e].substr(0,3),name:wa(e,rt(this.hass),!0)})),n=[{value:St.Monthly,name:Ws("ui.components.date.month_types_short.monthly",rt(this.hass))},{value:St.Custom,name:Ws("ui.components.date.month_types_short.choose",rt(this.hass))}];return q`
      <div class="header">${Ws("ui.components.date.month_types_short.months",rt(this.hass))}</div>
      <button-group .items=${n} value=${$a(this.schedule.months)} @change=${this.selectMonths}>
      </button-group>
      ${$a(this.schedule.months)==St.Custom?q`
            <div>
              <button-group
                .items=${o}
          ...
          `:""}
      <div class="header">${Ws("ui.components.date.days",rt(this.hass))}</div>
      <button-group .items=${a} value=${ja(this.schedule.weekdays)} @change=${this.selectDays}>
      </button-group>
      ${ja(this.schedule.weekdays)==Et.Custom?q`
            <div>
              <button-group
                .items=${s}
    ...
    `}renderActions(){var e;if(!this.hass||null!==this.activeMarker)return;const t=null!==this.activeEntry&&this.schedule.timeslots[this.activeEntry].actions.length?this.schedule.timeslots[this.activeEntry].actions[0]:null;return q`
      ...
      <button-group
        ...
        .value=${null!==t?null===(e=this.actions)||void 0===e?void 0:e.findIndex(e=>na(e,t,!0)):null}
        optional="true"
        @change=${this.selectAction}
      >
        ${Ws("ui.panel.time_picker.no_timeslot_selected",rt(this.hass))}
      </button-group>
  ...
  `,t([de()],yo.prototype,"hass",void 0),t([de()],yo.prototype,"config",void 0),t([de()],yo.prototype,"schedule",void 0),t([de()],yo.prototype,"actions",void 0),t([de()],yo.prototype,"entities",void 0),t([de()],yo.prototype,"activeEntry",void 0),t([de()],yo.prototype,"activeMarker",void 0),t([de({type:Boolean})],yo.prototype,"timeslots",void 0),t([de({type:Boolean})],yo.prototype,"editItem",void 0),t([de({type:Boolean})],yo.prototype,"large",void 0),yo=t([re("scheduler-editor-time")],yo);let ko=class extends oe{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.allowCustomValue=!1,this.invalid=!1}disconnectedCallback(){super.disconnectedCallback(),this._overlayMutationObserver&&(this._overlayMutationObserver.disconnect(),this._overlayMutationObserver=void 0)}open(){this.updateComplete.then(()=>{var e,t;null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t||t.open()})}focus(){this.updateComplete.then(()=>{var e,t,i;null===(i=null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t?void 0:t.inputElement)||void 0===i||i.focus()})}shouldUpdate(e){if(e.get("items"))if(tt(this.items,e.get("items"))){if(1==e.size)return!1}else this.firstUpdated();return!0}firstUpdated(){(async()=>{await vo()})(),this._comboBox.items=this.items}render(){return q`
        ...
        >
          ${et(this._value)&&this.items.find(e=>e.value==this._value)?q`
                ${this.icons?q`
                    ...
                    `:""}
                ${this.clearable?q`
                      <ha-icon-button slot="suffix" class="clear-button" @click=${this._clearValue} .path=${Ua}>
                      </ha-icon-button>
                    `:""}
              `:""}
        </ha-textfield>
    ...
    `}};t([de()],ko.prototype,"label",void 0),t([de()],ko.prototype,"value",void 0),t([de()],ko.prototype,"items",void 0),t([de()],ko.prototype,"clearable",void 0),t([de()],ko.prototype,"icons",void 0),t([de({type:Boolean})],ko.prototype,"disabled",void 0),t([ce()],ko.prototype,"_opened",void 0),t([de({attribute:"allow-custom-value",type:Boolean})],ko.prototype,"allowCustomValue",void 0),t([de({type:Boolean})],ko.prototype,"invalid",void 0),t([function(e,t){return ue({descriptor:i=>{const s={get(){var t,i;return null!==(i=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector(e))&&void 0!==i?i:null},enumerable:!0,configurable:!0};if(t){const t="symbol"==typeof i?Symbol():"__"+i;s.get=function(){var i,s;return void 0===this[t]&&(this[t]=null!==(s=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(e))&&void 0!==s?s:null),this[t]}}return s}})}("vaadin-combo-box-light",!0)],ko.prototype,"_comboBox",void 0),ko=t([re("scheduler-select")],ko);let wo=class extends oe{constructor(){super(...arguments),this.items=[],this.value=[],this.label="",this.invalid=!1}shouldUpdate(e){return e.get("items")&&(tt(this.items,e.get("items"))||this.firstUpdated()),!0}firstUpdated(){this.value.some(e=>!this.items.map(e=>e.value).includes(e))&&(this.value=this.value.filter(e=>this.items.map(e=>e.value).includes(e)),Ie(this,"value-changed",{value:this.value}))}render(){return q`
      <div class="chip-set">
    ...
    `}};t([de()],wo.prototype,"items",void 0),t([de({type:Array})],wo.prototype,"value",void 0),t([de()],wo.prototype,"label",void 0),t([de({type:Boolean})],wo.prototype,"invalid",void 0),wo=t([re("scheduler-selector")],wo);const xo=(e,t)=>{let i={};return(null==t?void 0:t.length)&&!t.includes(jt.Above)||(i=Object.assign(Object.assign({},i),{[jt.Above]:{value:jt.Above,name:e.localize("ui.panel.config.automation.editor.triggers.type.numeric_state.above"),icon:"mdi:greater-than"}})),(null==t?void 0:t.length)&&!t.includes(jt.Below)||(i=Object.assign(Object.assign({},i),{[jt.Below]:{value:jt.Below,name:e.localize("ui.panel.config.automation.editor.triggers.type.numeric_state.below"),icon:"mdi:less-than"}})),(null==t?void 0:t.length)&&!t.includes(jt.Equal)||(i=Object.assign(Object.assign({},i),{[jt.Equal]:{value:jt.Equal,name:Ws("ui.panel.conditions.equal_to",rt(e)),icon:"mdi:equal"}})),(null==t?void 0:t.length)&&!t.includes(jt.Unequal)||(i=Object.assign(Object.assign({},i),{[jt.Unequal]:{value:jt.Unequal,name:Ws("ui.panel.conditions.unequal_to",rt(e)),icon:"mdi:not-equal-variant"}})),i};let $o=class extends oe{constructor(){super(...arguments),this.editItem=!1,this.addCondition=!1,this.tags=[],this.startDate="",this.endDate=""}async firstUpdated(){var e,t,i;if(null===(e=this.config)||void 0===e?void 0:e.tags){(async()=>{await vo()})();const e=(await kt(this.hass)).map(e=>e.name),t=lt(this.config.tags);this.tags=[...e,...t.filter(t=>!e.includes(t)&&!["none","disabled","enabled"].includes(t))]}(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(t=this.schedule)||void 0===t?void 0:t.start_date)||bo(new Date,rt(this.hass),!0),this.endDate=(null===(i=this.schedule)||void 0===i?void 0:i.end_date)||bo(new Date,rt(this.hass),!0)}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){var e,t;if(!this.hass||!this.config||!this.schedule)return q``;let i=[{name:this.hass.localize("ui.panel.config.automation.editor.actions.type.repeat.label"),value:xt.Repeat,icon:"refresh"},{name:this.hass.localize("ui.dialogs.more_info_control.vacuum.stop"),value:xt.Pause,icon:"stop"},{name:this.hass.localize("ui.common.delete"),value:xt.Single,icon:"trash-can-outline"}];return et(this.schedule.start_date)&&(i=i.filter(e=>e.value!=xt.Repeat)),q`
        <div class="content">
          ${this.addCondition?this.renderAddCondition():q`
                  ...
                  <div class="condition-options">
                    ...
                    <div class="track-conditions">
                      ${this.schedule.timeslots[0].stop&&this.schedule.timeslots[0].conditions&&this.schedule.timeslots[0].conditions.length>0?q`
                            ...
                            >
                              ${Ws("ui.panel.conditions.track_conditions",rt(this.hass))}
                            </span>
                          `:""}
                    </div>
                  </div>

                  <div class="header">${Ws("ui.panel.options.period",rt(this.hass))}</div>
                  <div class="checkbox-container">
                    <div class="checkbox">
                      <ha-checkbox
                    ...
                    <div class="slider date-range">
                      <div>
                        <span>
                          ${at((null===(e=Ws("ui.components.date.days_range",rt(this.hass)).split("{").shift())||void 0===e?void 0:e.trim())||"")}
                        </span>
                        <ha-date-input
                      ...
                      <div>
                        <span>
                          ${at((null===(t=Ws("ui.components.date.days_range",rt(this.hass)).split("}")[1].split("{").shift())||void 0===t?void 0:t.trim())||"")}
                        </span>
                        <ha-date-input
                          .locale=${this.hass.locale}
                          value=${this.endDate}
                  ...
                  <div class="header">${Ws("ui.panel.options.repeat_type",rt(this.hass))}</div>
                  <button-group
                    .items=${i}
    ...
    `}renderAddCondition(){if(!this.addCondition||!this.hass||!this.config)return q``;if(this.selectedEntity){const e=this.selectedEntity,t=to(e.id,this.hass,this.config);let i;if((null==t?void 0:t.type)==$t.Level)i=[jt.Above,jt.Below];else if((null==t?void 0:t.type)==$t.List)i=[jt.Equal,jt.Unequal];else{const t=e.id in this.hass.states?this.hass.states[e.id].state:null;i=!t||["unavailable","unknown"].includes(t)?[jt.Equal,jt.Unequal,jt.Above,jt.Below]:isNaN(Number(t))?[jt.Equal,jt.Unequal]:[jt.Above,jt.Below]}const s=xo(this.hass,i);return q`
  ...
  `,t([de()],$o.prototype,"hass",void 0),t([de()],$o.prototype,"config",void 0),t([de()],$o.prototype,"schedule",void 0),t([de()],$o.prototype,"selectedGroup",void 0),t([de()],$o.prototype,"selectedEntity",void 0),t([de()],$o.prototype,"conditionMatchType",void 0),t([de()],$o.prototype,"conditionValue",void 0),t([de()],$o.prototype,"editConditionItem",void 0),t([de({type:Boolean})],$o.prototype,"editItem",void 0),t([de()],$o.prototype,"addCondition",void 0),t([de()],$o.prototype,"tags",void 0),t([ce()],$o.prototype,"startDate",void 0),t([ce()],$o.prototype,"endDate",void 0),$o=t([re("scheduler-editor-options")],$o);let jo=class extends oe{constructor(){super(...arguments),this.actions=[],this.editItem=null,this.large=!1,this._currTab=Be.Entity,this._tabs=[Be.Entity,Be.Time,Be.Options]}provideHass(e){e.hass=this.hass}async showDialog(e){this._params=e,this._config=e.config,this.entities=e.entities,this.actions=e.actions,this.schedule=e.schedule,this.editItem=e.editItem,this.cardEmbeddedInPopup=e.cardEmbeddedInPopup,this._currTab=null!==this.editItem?Be.Time:Be.Entity,await this.updateComplete}async closeDialog(){this._params=void 0,this.large=!1}render(){var e,t,i,s;const a=null===(e=this.schedule)||void 0===e?void 0:e.timeslots.every(e=>e.stop),o=e=>e==Be.Entity?this.hass.localize("ui.components.entity.entity-picker.entity"):e==Be.Time?this.hass.localize("ui.dialogs.helper_settings.input_datetime.time"):e==Be.Options?this.hass.localize("ui.dialogs.helper_settings.input_select.options"):e;return this._params?q`
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        <ha-dialog-header slot="heading">
          ...
          <span slot="title" @click=${this._enlarge}>
            ${this.editItem?(null===(t=this.schedule)||void 0===t?void 0:t.name)?null===(i=this.schedule)||void 0===i?void 0:i.name:Ws("ui.panel.common.default_name",rt(this.hass),"{id}",this.editItem):Ws("ui.panel.common.new_schedule",rt(this.hass))}
          </span>
        </ha-dialog-header>
    ...
    `:q``}_handleUpdateParams(e){const t=e.detail;t.schedule&&(this.schedule=t.schedule),t.actions&&(this.actions=t.actions),t.entities&&(this.entities=t.entities),t.tab&&(this._currTab=t.tab)}_handleTabChanged(e){const t=this._currTab,i=this._tabs[e.detail.selected];if(i!=Be.Time&&!this.schedule)return e.preventDefault(),void(e.target.activeIndex=0);i!==t&&(this._currTab=i)}_enlarge(){this.large=!this.large}async _handleSaveClick(){if(!this.hass)return;let e=Object.assign({},this.schedule);if(e=Object.assign(Object.assign({},e),{timeslots:e.timeslots.map(e=>{var t;return e.actions&&e.actions.length?(e.actions.some(e=>!e.entity_id||"notify"==Le(e.entity_id||""))&&(e=Object.assign(Object.assign({},e),{actions:e.actions.map(e=>e.entity_id&&"notify"!=Le(e.entity_id||"")?e:Je(e,"entity_id"))})),e.stop||(e=Je(e,"stop")),(null===(t=e.conditions)||void 0===t?void 0:t.length)||(e=Je(e,"conditions","condition_type")),e):null}).filter(et)}),this.editItem){const s=await yt(this.hass,this.editItem);if(tt(Je(e,"timeslots"),Je(Ke(s,Object.keys(e)),"timeslots"))&&e.timeslots.length==s.timeslots.length&&e.timeslots.every((e,t)=>tt(e,s.timeslots[t])));else{if(!s.enabled){await new Promise(e=>{const t={title:Ws("ui.dialog.enable_schedule.title",rt(this.hass)),description:Ws("ui.dialog.enable_schedule.description",rt(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{e(!1)},confirm:()=>{e(!0)}};gt(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return lo})),dialogParams:t},this.cardEmbeddedInPopup)})&&this.hass.callService("switch","turn_on",{entity_id:s.entity_id})}(function(e){return!!e&&null!==e.match(/^Schedule\ #[a-f0-9]{6}/)})(e.name)&&(e=Object.assign(Object.assign({},e),{name:""})),(t=this.hass,i=Object.assign(Object.assign({},e),{schedule_id:this.editItem}),t.callApi("POST","scheduler/edit",i)).catch(e=>wt(e,this,this.hass,this.cardEmbeddedInPopup)).then(()=>{this.closeDialog()})}}else((e,t)=>e.callApi("POST","scheduler/add",t))(this.hass,e).catch(e=>wt(e,this,this.hass,this.cardEmbeddedInPopup)).then(()=>{this.closeDialog()});var t,i}async _handleDeleteClick(e){if(!this.editItem)return;e.target;await new Promise(e=>{const t={title:Ws("ui.dialog.confirm_delete.title",rt(this.hass)),description:Ws("ui.dialog.confirm_delete.description",rt(this.hass)),primaryButtonLabel:this.hass.localize("ui.dialogs.generic.ok"),secondaryButtonLabel:this.hass.localize("ui.dialogs.generic.cancel"),cancel:()=>{e(!1)},confirm:()=>{e(!0)}};gt(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return lo})),dialogParams:t},this.cardEmbeddedInPopup)})&&bt(this.hass,this.editItem).catch(e=>wt(e,this,this.hass,this.cardEmbeddedInPopup)).then(()=>{this.closeDialog()})}static get styles(){return r`
      ${Ra}
    ...
    `}};t([de()],jo.prototype,"_config",void 0),t([ce()],jo.prototype,"_params",void 0),t([de()],jo.prototype,"editItem",void 0),t([de({type:Boolean,reflect:!0})],jo.prototype,"large",void 0),t([ce()],jo.prototype,"_currTab",void 0),jo=t([re("scheduler-editor-dialog")],jo);var zo=Object.freeze({__proto__:null,get SchedulerEditorDialog(){return jo}});let Oo=class extends oe{constructor(){super(...arguments),this.scheduleEntities=[],this._cardTab=!1,this.selectedDomain=""}setConfig(e){this._config=e}async firstUpdated(){await vo(),this.scheduleEntities=(await ft(this.hass)).map(e=>e.entity_id);const e=(await kt(this.hass)).map(e=>e.name);e.sort(it),this.tagOptions=e}render(){return this.hass&&this._config?q`
      <paper-tabs .selected=${this._cardTab?1:0} @iron-activate=${this._selectTab}>
        <paper-tab>${Ws("ui.panel.card_editor.tabs.entities",rt(this.hass))}</paper-tab>
        <paper-tab>${Ws("ui.panel.card_editor.tabs.other",rt(this.hass))}</paper-tab>
      </paper-tabs>

      <div class="card-config">
        ${this._cardTab?q`
              <div class="header">${Ws("ui.panel.card_editor.fields.title.heading",rt(this.hass))}</div>
              <button-group
                .items=${[{name:Ws("ui.panel.card_editor.fields.title.options.standard",rt(this.hass)),value:"standard"},{name:Ws("ui.panel.card_editor.fields.title.options.hidden",rt(this.hass)),value:"hidden"},{name:Ws("ui.panel.card_editor.fields.title.options.custom",rt(this.hass)),value:"custom"}]}
              ...
              ${"string"==typeof this._config.title?q`
                    <ha-textfield
                      label=${Ws("ui.panel.card_editor.fields.title.custom_title",rt(this.hass))}
              ...
              <div class="header">
                ${Ws("ui.panel.card_editor.fields.discover_existing.heading",rt(this.hass))}
              </div>
              <div class="text-field">
                ${Ws("ui.panel.card_editor.fields.discover_existing.description",rt(this.hass))}
              </div>
              <ha-switch
              ...
              <div class="header">
                ${Ws("ui.panel.card_editor.fields.time_step.heading",rt(this.hass))}
              </div>
              <div class="text-field">
                ${Ws("ui.panel.card_editor.fields.time_step.description",rt(this.hass))}
              </div>
              <variable-slider
                min="1"
                max="30"
              ...
              <div class="header">
                ${Ws("ui.panel.card_editor.fields.sort_by.heading",rt(this.hass))}
              </div>
              <div class="text-field">
                ${Ws("ui.panel.card_editor.fields.sort_by.description",rt(this.hass))}
              </div>

              <div>
                <ha-formfield
                  label=${Ws("ui.panel.card_editor.fields.sort_by.options.relative_time",rt(this.hass))}
                >
                  <ha-radio
                    name="sort_by"
                ...
                <ha-formfield
                  label=${Ws("ui.panel.card_editor.fields.sort_by.options.title",rt(this.hass))}
                >
                  <ha-radio
                    name="sort_by"
              ...
              <div>
                <ha-formfield
                  label=${Ws("ui.panel.card_editor.fields.sort_by.options.state",rt(this.hass))}
                >
                  <ha-checkbox
              ...
              <div class="header">
                ${Ws("ui.panel.card_editor.fields.display_format_primary.heading",rt(this.hass))}
              </div>
              <div class="text-field">
                ${Ws("ui.panel.card_editor.fields.display_format_primary.description",rt(this.hass))}
              </div>

              <ha-formfield
                label=${Ws("ui.panel.card_editor.fields.display_format_primary.options.default",rt(this.hass))}
              >
                <ha-radio
                  name="primary_info"
              ...
              <ha-formfield
                label=${Ws("ui.panel.card_editor.fields.display_format_primary.options.entity_action",rt(this.hass))}
              >
                <ha-radio
                  name="primary_info"
              ...
              <div class="header">
                ${Ws("ui.panel.card_editor.fields.display_format_secondary.heading",rt(this.hass))}
              </div>
              <div class="text-field">
                ${Ws("ui.panel.card_editor.fields.display_format_secondary.description",rt(this.hass))}
              </div>

              <ha-formfield
                label=${Ws("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",rt(this.hass))}
              >
                <ha-checkbox
              ...
              <ha-formfield
                label=${Ws("ui.panel.card_editor.fields.display_format_secondary.options.time",rt(this.hass))}
              >
                <ha-checkbox
              ...
              <ha-formfield
                label=${Ws("ui.panel.card_editor.fields.display_format_secondary.options.days",rt(this.hass))}
              >
                <ha-checkbox
              ...
              <ha-formfield
                label=${Ws("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",rt(this.hass))}
              >
                <ha-checkbox
              ...
              <div class="header">
                ${Ws("ui.panel.card_editor.fields.show_header_toggle.heading",rt(this.hass))}
              </div>
              <div class="text-field">
                ${Ws("ui.panel.card_editor.fields.show_header_toggle.description",rt(this.hass))}
              </div>
              <ha-switch
              ...
              ${void 0!==this.tagOptions?q`
                    <div class="header">
                      ${Ws("ui.panel.card_editor.fields.tags.heading",rt(this.hass))}
                    </div>
                    <div class="text-field">
                      ${Ws("ui.panel.card_editor.fields.tags.description",rt(this.hass))}
                    </div>
                    <scheduler-selector
                      .items=${this.getTagOptions()}
    ...
    `:q``}_selectTab(e){this._cardTab=1===e.detail.selected}_updateConfig(e){this._config&&(this._config=Object.assign(Object.assign({},this._config),e),Ie(this,"config-changed",{config:this._config}))}_setTitleFormatOption(e){var t;this.hass&&("standard"==e?this._updateConfig({title:!0}):"hidden"==e?this._updateConfig({title:!1}):this._updateConfig({title:"string"==typeof(null===(t=this._config)||void 0===t?void 0:t.title)?this._config.title:Ws("ui.panel.common.title",rt(this.hass))}))}getTitleOption(){return this.hass&&this._config?"string"==typeof this._config.title?"custom":this._config.title?"standard":"hidden":""}updateTags(e){if(!this._config||!this.hass)return;let t=e.target.value;t=t.map(e=>e.trim()),t.sort(it),this._updateConfig({tags:t})}getTagOptions(){if(!this._config||!this.hass)return[];let e=this.tagOptions||[];if(this._config.tags){const t=lt(this._config.tags);e=[...e,...t.filter(t=>!e.includes(t))]}return e.map(e=>Object({name:e,value:e}))}_setSortBy(e){var t;const i=e.target.checked,s=e.target.value;let a=lt((null===(t=this._config)||void 0===t?void 0:t.sort_by)||Fe.sort_by);"state"!=s&&i&&(a=a.filter(e=>"state"==e)),!a.includes(s)&&i&&(a=[...a,s]),a.includes(s)&&!i&&(a=a.filter(e=>e!=s)),this._updateConfig({sort_by:a})}_setDisplayOptionsPrimary(e){var t;const i=e.target.value,s=Object.assign(Object.assign({},(null===(t=this._config)||void 0===t?void 0:t.display_options)||Fe.display_options),{primary_info:i});this._updateConfig({display_options:s})}_setDisplayOptionsSecondary(e){var t;const i=e.target.value,s=e.target.checked;let a=Object.assign({},(null===(t=this._config)||void 0===t?void 0:t.display_options)||Fe.display_options),o=lt(a.secondary_info||[]);o=s?Array.from(new Set([...o,i])):o.filter(e=>e!==i),o.sort((e,t)=>{const i={"relative-time":1,time:o.includes("relative-time")?3:2,days:o.includes("relative-time")?2:3,"additional-tasks":4},s=Object.keys(i).includes(e)?i[e]:5,a=Object.keys(i).includes(t)?i[t]:5;return s>a?1:s<a?-1:0}),a=Object.assign(Object.assign({},a),{secondary_info:[...o]}),this._updateConfig({display_options:a})}getDomainSwitches(){if(!this._config||!this.hass)return;const e=io(this.hass,Object.assign(Object.assign({},Fe),{include:["*"]}),{filterActions:!0,filterStates:!0}).filter(e=>"switch"!==Le(e)||!this.scheduleEntities.includes(e)).map(e=>ht(e,this.hass,{include:["*"]})).filter(e=>Qa(e.id,this.hass)||va(e.id,this.hass,Fe)),t=e.map(e=>Le(e.id)).filter((e,t,i)=>i.indexOf(e)===t);return t.sort((e,t)=>e.trim().toLowerCase()<t.trim().toLowerCase()?-1:1),t.map(t=>{var i;const s=e.filter(e=>Le(e.id)==t).length,a=e.filter(e=>Le(e.id)==t),o=a.filter(e=>fa(e.id,this._config)).length;return s?q`
        <div class="row" @click=${()=>this.toggleShowDomain(t)}>
          ...
          <div class="info">
            ${t}
            <div class="secondary">
              ${Ws("ui.panel.card_editor.fields.entities.included_number",rt(this.hass),["{number}","{total}"],[o,s])}
            </div>
          </div>
          <ha-switch
            @click=${e=>e.stopPropagation()}
            @change=${e=>this.toggleSelectEntity(t,e.target.checked)}
            ?checked=${fa(t,this._config)}
            ?disabled=${fa(t,{groups:null===(i=this._config)||void 0===i?void 0:i.groups})}
          >
          </ha-switch>
        </div>
        ${this.selectedDomain==t?q`
              ...
              ${a.map(e=>{var i,s;return q`
                  <div class="row" @click=${()=>this.toggleSelectEntity(e.id)}>
                    ...
                    <ha-switch
                      ?checked=${fa(e.id,this._config)}
                      ?disabled=${fa(e.id,{groups:null===(i=this._config)||void 0===i?void 0:i.groups})||fa(t,{groups:null===(s=this._config)||void 0===s?void 0:s.groups})}
                    ></ha-switch>
                  </div>
                `})}
              <div class="divider"></div>
            `:""}
      `:""})}toggleShowDomain(e){this._config&&this.hass&&(this.selectedDomain!=e?this.selectedDomain=e:this.selectedDomain="")}toggleSelectEntity(e,t){if(!this._config||!this.hass)return;const i=fa(e,this._config);void 0===t&&(t=!i);const s=Le(e);let a=[...this._config.include||[]],o=[...this._config.exclude||[]];if(!i&&t)o.includes(e)&&(o=o.filter(t=>t!=e)),a.includes(e)||(a=[...a,e]);else{if(!i||t)return;(s&&a.includes(s)||fa(e,{customize:this._config.customize})||s&&fa(s,{customize:this._config.customize}))&&(o=[...o,e]),a.includes(e)&&(a=a.filter(t=>t!=e))}a.sort(it),o.sort(it),this._updateConfig({include:a,exclude:o})}static get styles(){return r`
      ${Va}
    ...
    `}};t([de()],Oo.prototype,"hass",void 0),t([de()],Oo.prototype,"_config",void 0),t([de()],Oo.prototype,"scheduleEntities",void 0),t([de()],Oo.prototype,"tagOptions",void 0),t([ce()],Oo.prototype,"_cardTab",void 0),t([de()],Oo.prototype,"selectedDomain",void 0),Oo=t([re("scheduler-card-editor")],Oo);let So=class extends oe{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=bo(e,rt(this._hass)):s>7?a=Ws("ui.components.date.next_week_day",rt(this._hass),"{weekday}",xa(e,rt(this._hass))):1==s?a=Ws("ui.components.date.tomorrow",rt(this._hass)):s>0&&(a=xa(e,rt(this._hass)));let o=Ws("ui.components.time.absolute",rt(this._hass),"{time}",Sa(e,rt(this._hass)));return 12==e.getHours()&&0==e.getMinutes()?o=Ws("ui.components.time.at_noon",rt(this._hass)):0==e.getHours()&&0==e.getMinutes()&&(o=Ws("ui.components.time.at_midnight",rt(this._hass))),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(rt(this._hass).language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(rt(this._hass).language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(rt(this._hass).language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(rt(this._hass).language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=Vt(Vt({},Rt),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var m=a/604800;return{value:Math.round(m),unit:"week"}}(e);return new Intl.RelativeTimeFormat(rt(this._hass).language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return q``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),q`
      ${st(this.relativeTime(this.datetime))}
    `}};t([de()],So.prototype,"_hass",void 0),t([de()],So.prototype,"datetime",void 0),So=t([re("my-relative-time")],So),window.customCards=window.customCards||[],window.customCards.push({type:"scheduler-card",name:"Scheduler Card",description:"Card to manage schedule entities made with scheduler-component."}),console.info("%c  SCHEDULER-CARD  \n%c  Version: "+"v3.2.14".padEnd(7," "),"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const Eo=e=>new Date(e.timestamps[e.next_entries[0]]).valueOf(),Ao=(e,t)=>{var i,s;if(!e.timeslots.every(e=>e.actions.every(e=>fa(e.entity_id||e.service,t))))return!1;let a=!0;const o=lt(t.tags);o.length&&(a=!1,((e.tags||[]).some(e=>o.includes(e))||o.includes("none")&&!(null===(i=e.tags)||void 0===i?void 0:i.length)||o.includes("enabled")&&e.enabled||o.includes("disabled")&&!e.enabled)&&(a=!0));const n=lt(t.exclude_tags);return n.length&&a&&((e.tags||[]).some(e=>n.includes(e))||n.includes("none")&&!(null===(s=e.tags)||void 0===s?void 0:s.length)||n.includes("enabled")&&e.enabled||n.includes("disabled")&&!e.enabled)&&(a=!1),a},Co=(e,t)=>!!t.discover_existing||!!e&&Ao(e,t),Mo=(e,t,i)=>({primaryInfo:Aa(e,t,i),secondaryInfo:Ca(e,t,i),icon:Ma(e,t,i)});e.SchedulerCard=class extends(La(oe)){constructor(){super(...arguments),this.showDiscovered=!1,this.translationsLoaded=!1,this.scheduleDisplayInfo={},this.connectionError=!1}static getConfigElement(){return document.createElement("scheduler-card-editor")}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.updateScheduleItem(e),{type:"scheduler_updated"})]}firstUpdated(){const e=this.hass;if(e.localize("ui.panel.config.automation.editor.actions.type.device_id.action"))this.translationsLoaded=!0;else{document.querySelector("home-assistant")._loadFragmentTranslations(e.language,"config").then(()=>{this.hass.localize})}}provideHass(e){e.hass=this.hass}async updateScheduleItem(e){var t;"scheduler_item_removed"!=e.event?yt(this.hass,e.schedule_id).then(t=>{var i;const s=null===(i=this.schedules)||void 0===i?void 0:i.find(t=>t.schedule_id==e.schedule_id);let a=[...this.schedules||[]];try{this.scheduleDisplayInfo=Object.assign(Object.assign({},this.scheduleDisplayInfo),{[t.schedule_id]:Mo(t,this._config,this.hass)})}catch(e){}t&&Co(t,this._config)?a=s?Eo(s)==Eo(t)?a.map(e=>e.schedule_id==t.schedule_id?t:e):this.sortSchedules(a.map(e=>e.schedule_id==t.schedule_id?t:e)):this.sortSchedules([...a,t]):s&&(a=a.filter(t=>t.schedule_id!=e.schedule_id)),this.schedules=[...a]}):this.schedules=null===(t=this.schedules)||void 0===t?void 0:t.filter(t=>t.schedule_id!=e.schedule_id)}async loadSchedules(){ft(this.hass).then(e=>{const t=e.filter(e=>Co(e,this._config));let i={};Object.keys(t).forEach(e=>{try{i=Object.assign(Object.assign({},i),{[t[e].schedule_id]:Mo(t[e],this._config,this.hass)})}catch(e){}}),this.scheduleDisplayInfo=i,this.schedules=this.sortSchedules(t)}).catch(e=>{this.schedules=[],this.connectionError=!0})}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(t&&1==e.size&&!this.translationsLoaded&&(t.localize("ui.panel.config.automation.editor.actions.type.device_id.action")||(this.translationsLoaded=!0)),i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!t||1!=e.size||!this.schedules||this.schedules.some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}setConfig(e){dt(e);const t=Object.assign(Object.assign({},Fe),e);this._config=t}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let s=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(s+=1);const a=((lt(this._config.display_options.secondary_info||[]).length||2)+1)/2;this.schedules&&(s+=this.showDiscovered?this.schedules.length*a:this.schedules.filter(e=>Ao(e,this._config)).length*a),clearInterval(i),e(Math.round(s))},50)})}render(){return this.hass&&this._config&&this.schedules?q`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this._config.title?"string"==typeof this._config.title?this._config.title:Ws("ui.panel.common.title",rt(this.hass)):""}
          </div>
    ...
    `:q``}renderRows(){if(!this._config||!this.hass||!this.schedules)return q``;if(this.connectionError)return q`
        <div>
          <hui-warning>
            ${Ws("ui.panel.overview.backend_error",rt(this.hass))}
          </hui-warning>
        </div>
      `;if(!Object.keys(this.schedules).length)return q`
        <div>
          ${Ws("ui.panel.overview.no_entries",rt(this.hass))}
        </div>
      `;const e=this.schedules.filter(e=>Ao(e,this._config)),t=this.schedules.filter(e=>!Ao(e,this._config));return q`
      ...
      ${Object.keys(t).length?this.showDiscovered?q`
              ...
              <div>
                ...
                >
                  ${st(Ws("ui.panel.overview.hide_excluded",rt(this.hass)))}
                </button>
              </div>
            `:q`
              <div>
                ...
                >
                  +
                  ${Ws("ui.panel.overview.excluded_items",rt(this.hass),"{number}",t.length)}
                </button>
              </div>
            `:""}
    ...
    `}renderDisplayItems(e,t){const i=t=>{const i=t.split("<my-relative-time></my-relative-time>");if(i.length>1)return q`
          ...
          ${i[1]?qa(i[1]):""}
        `;const s=t.split(/(<tag>[^<]*<\/tag>)/g);return s.length>1?s.filter(e=>e.length).map(e=>{const t=e.match(/<tag>([^<]*)<\/tag>/g);return t?qa(`<span class="filter-tag">${t[0]}</span>`):e}):qa(t)};return t.filter(et).map(e=>q`
          ${i(e)}<br />
        `)}sortSchedules(e){var t;const i=lt(null===(t=this._config)||void 0===t?void 0:t.sort_by);if(i.includes("relative-time")&&(e=(e=>{const t=[...e];return t.sort((e,t)=>{const i=Eo(e),s=Eo(t),a=(new Date).valueOf(),o=i<a&&s<a;return null!==i&&null!==s?i<a&&s>=a?1:i>=a&&s<a?-1:i>s?o?-1:1:i<s?o?1:-1:e.entity_id<t.entity_id?1:-1:null!==s?1:null!==i?-1:e.entity_id<t.entity_id?1:-1}),t})(e)),i.includes("title")&&(e=((e,t)=>{const i=[...e];return i.sort((e,i)=>{if(!t[e.schedule_id])return t[i.schedule_id]?1:-1;return it(t[e.schedule_id].primaryInfo.join(""),t[i.schedule_id].primaryInfo.join(""))}),i})(e,this.scheduleDisplayInfo)),i.includes("state")){const t=i.includes("relative-time");e=((e,t,i)=>{const s=[...e];return s.sort((e,s)=>{var a,o;const n=null===(a=t.states[e.entity_id])||void 0===a?void 0:a.state,r=null===(o=t.states[s.entity_id])||void 0===o?void 0:o.state,l=["on","triggered"].includes(n),d=["on","triggered"].includes(r);if(l&&!d)return-1;if(!l&&d)return 1;if(i){if("off"!=n&&"off"==r)return 1;if("off"==n&&"off"!=r)return-1}return 0}),s})(e,this.hass,t)}return e}toggleDisabled(e,t){if(!this.hass||!t)return;e.stopPropagation();const i=!e.target.checked;this.hass.callService("switch",i?"turn_on":"turn_off",{entity_id:t})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;this.schedules.filter(e=>this.showDiscovered?Co(e,this._config):Ao(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}computeHeaderToggleState(){if(!this.schedules)return!1;return this.schedules.filter(e=>this.showDiscovered?Co(e,this._config):Ao(e,this._config)).some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")})}_addItemClick(){gt(this,{dialogTag:"scheduler-editor-dialog",dialogImport:()=>Promise.resolve().then((function(){return zo})),dialogParams:{config:this._config,editItem:null,entities:[],actions:[],schedule:void 0}})}async _editItemClick(e){if(!this.hass||!this._config)return;const t=await yt(this.hass,e);if(!t)return;const i=Qe(Xe(t.timeslots.map(e=>e.actions.map(e=>e.entity_id||e.service)))),s=i.map(e=>ht(e,this.hass,this._config));let a=va(i,this.hass,this._config);const o=Qe(Xe(t.timeslots.map(e=>e.actions))),n=o.filter(e=>!a.some(t=>na(t,e,!0)));n.length&&Qe(n).forEach(e=>a.push(ga(e,this.hass)));let r={months:t.months,weekdays:t.weekdays,timeslots:t.timeslots,repeat_type:t.repeat_type,name:t.name,tags:t.tags||[],start_date:t.start_date,end_date:t.end_date};if(s.length&&r.timeslots.length){if(r.timeslots.every(e=>e.stop)){if(r=Object.assign(Object.assign({},r),{timeslots:nt(r.timeslots,this.hass)}),!a.length)return wt({error:"",body:{message:`Could not compute actions for the schedule #${e}.`}},this,this.hass)}else if(a=a.filter(e=>o.find(t=>na(e,t,!0))).reduce((e,t)=>[t],[]),!a.length)return wt({error:"",body:{message:`Could not compute actions for schedule #${e}.`}},this,this.hass);gt(this,{dialogTag:"scheduler-editor-dialog",dialogImport:()=>Promise.resolve().then((function(){return zo})),dialogParams:{config:this._config,editItem:t.schedule_id,actions:a,entities:s,schedule:r,cardEmbeddedInPopup:_t(this)}})}else{await new Promise(e=>{const t={title:"Defective entity",description:"This schedule is defective and cannot be edited with the card. Consider to delete the item and recreate it. If the problem persists, please report the issue on GitHub.",primaryButtonLabel:this.hass.localize("ui.common.delete"),primaryButtonCritical:!0,secondaryButtonLabel:this.hass.localize("ui.dialogs.generic.cancel"),cancel:()=>{e(!1)},confirm:()=>{e(!0)}};gt(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return lo})),dialogParams:t})})&&bt(this.hass,t.schedule_id).catch(e=>wt(e,this,this.hass))}}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}},e.SchedulerCard.styles=r`
    ${Va}
    hui-warning {
      padding: 10px 0px;
    }
