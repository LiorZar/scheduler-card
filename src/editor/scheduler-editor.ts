...
import { ConxDomain, ETabOptions, NotifyDomain } from '../const';
                ...
                .map(slot => {
                    ...
                    if (
                        slot.actions.some(
                            e =>
                                !e.entity_id ||
                                computeDomain(e.entity_id || '') == NotifyDomain ||
                                computeDomain(e.entity_id || '') == ConxDomain
                        )
                    ) {
                        slot = {
                            ...slot,
                            actions: slot.actions.map(action =>
                                !action.entity_id ||
                                    computeDomain(action.entity_id || '') == NotifyDomain ||
                                    computeDomain(action.entity_id || '') == ConxDomain
