...
export class TimeslotEditor extends LitElement {
    ...
    render() {
      ...
      <ha-button type="button" @click=${this._addSlot} ?disabled=${this.activeSlot === null || this.slots.length >= 24}>
      ...
      <ha-button type="button" @click=${this._removeSlot} ?disabled=${this.activeSlot === null || this.slots.length <= 2}>
